...
@section('container')
        ...
        <div class="row">
          ...
          <div class="col-auto ml-auto">
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ route('transaksi-kas.index') }}" method="get">
        ...
        <div class="table-responsive">
                            ...
                            <td>
                                {{-- <div class="dropdown dropdown-link">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{ route('transaksi-kas.edit', $value->kode_kas) }}" class="dropdown-item">{{ __('Edit') }}</a>
                                        <form action="{{ route('transaksi-kas.destroy', $value->kode_kas) }}" method="post">
                                            @csrf
                                            @method('delete')
                                ...
                                <div class="form-inline">
                                    <a href="{{ route('transaksi-kas.edit', $value) }}" class="btn btn-success mr-2"> <span class="fa fa-pen"></span> </a>
                                    <form action="{{ route('transaksi-kas.destroy', $value) }}" method="post">
                                        @csrf
                                        @method('delete')
            ...
            {{$kas->appends(Request::all())->links('vendor.pagination.custom')}}
        </div>
@endsection
