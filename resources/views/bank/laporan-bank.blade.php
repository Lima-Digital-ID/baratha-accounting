...
<div class="card shadow py-2">
    <div class="card-body">
        ...
        <form action="{{ route('laporan-bank') }}" method="GET">
            <h6 class="heading-small text-muted mb-3">Laporan Bank</h6>
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row d-flex justify-content-between">
                ...
                <div class="form-group mt-3 mr-3">
                    <a href="{{ route('print-bank')."?start=$_GET[start]&end=$_GET[end]&kode_perkiraan=$_GET[kode_perkiraan]" }}" class="btn btn-primary btn-sm">
                        <i class="fa fa-print" aria-hidden="true"></i> Cetak
                    </a>
                    <a href="{{ route('print-bank')."?start=$_GET[start]&end=$_GET[end]&kode_perkiraan=$_GET[kode_perkiraan]&xls=true" }}" class="btn btn-success btn-sm">
