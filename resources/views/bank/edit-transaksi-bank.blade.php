    ...
    <div class="card-body">
        ...
        <form action="{{ route('transaksi-bank.update', $bank->kode_bank) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <label>Tanggal</label>
                    <input type="text" class="form-control datepickerDate {{ $errors->has('tanggal', $bank->tanggal) ? ' is-invalid' : '' }}" value="{{ old('tanggal', $bank->tanggal) }}" name="tanggal" placeholder="Tanggal" autocomplete="off" id="tanggal">
            ...
            <div class="tab-content mb-4">
                <div class="tab-pane <?= empty($_GET['page']) ? "active" : ""   ?>">
                    ...
                    <div class="tab-pane active">
                        ...
                        <?php } else{?>
                            @include('penjualan.customer.list-piutang',['piutang' => $piutang, 'sisaDetail' => $total- $totalBayar->total, 'kode_transaksi' => $bank->kode_bank,'kode_customer' => $bank->kode_customer])
                        <?php }  ?>
