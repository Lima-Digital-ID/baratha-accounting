...
@section('container')
        ...
        <div class="row">
          ...
          <div class="col-auto ml-auto">
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ route('transaksi-bank.index') }}" method="get">
        ...
        <div class="table-responsive">
                            ...
                            <td>
                                {{-- <div class="dropdown dropdown-link">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{ route('transaksi-bank.edit', $value->kode_bank) }}" class="dropdown-item">{{ __('Edit') }}</a>
                                        <form action="{{ route('transaksi-bank.destroy', $value->kode_bank) }}" method="post">
                                            @csrf
                                            @method('delete')
                                ...
                                <div class="form-inline">
                                    <a href="{{ route('transaksi-bank.edit', $value) }}" class="btn btn-success mr-2"> <span class="fa fa-pen"></span> </a>
                                    <form action="{{ route('transaksi-bank.destroy', $value) }}" method="post">
                                        @csrf
                                        @method('delete')
            ...
            {{$bank->appends(Request::all())->links('vendor.pagination.custom')}}
        </div>
@endsection
