        ...
        <form action="{{ route('transaksi-bank.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="kode_customer" class="form-control setLawan select2 @error('kode_customer') is-invalid @enderror" data-tipe='customer' id="kode_customer" {{old('kode_customer')=='' ? 'disabled' : ''}}>
