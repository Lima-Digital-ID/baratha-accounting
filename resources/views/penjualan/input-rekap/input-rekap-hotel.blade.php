            ...
            <div class="card-body">
                <form action="" method="" id="rekap-hotel">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control datepicker" value="{{ isset($_GET['tanggal']) ? $_GET['tanggal'] : date('Y-m-d') }}" name="tanggal" placeholder="Pilih Tanggal" autocomplete="off" required>
                    </div>
