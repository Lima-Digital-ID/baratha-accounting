...
<div class="card shadow py-2">
  <div class="card-body">
    ...
    <form action="{{ route('supplier.update', $supplier->kode_supplier) }}" method="POST">
      ...
      <input type="text" class="form-control {{ $errors->has('kode_supplier') ? ' is-invalid' : '' }}" value="{{ old('kode_supplier', $supplier->kode_supplier) }}" autofocus name="kode_supplier" placeholder="ex : Supplier 1" readonly>
