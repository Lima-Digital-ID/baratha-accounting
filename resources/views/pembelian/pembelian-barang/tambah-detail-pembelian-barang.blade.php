<div class="row row-detail mb-3" data-no='{{$no}}'>
  ...
  <div class="col-md-3">
    ...
    <input type="number" step=".01" name="harga_satuan[]" value="{{isset($n) ? old('harga_satuan.'.$n) : ''}}" class="form-control getSubtotal {{ isset($n)&&$errors->has('harga_satuan.'.$n) ? ' is-invalid' : '' }}" data-other='#qty' id='harga_satuan'>
  ...
  <div class="col-md-2">
      ...
      <input type="number" step=".01" name="qty[]" value="{{isset($n) ? old('qty.'.$n) : ''}}" class="form-control getSubtotal getTotalQty {{ isset($n)&&$errors->has('qty.'.$n) ? ' is-invalid' : '' }}" data-other='#harga_satuan' id='qty'>
  ...
  <div class="col-md-3">
      ...
      <input type="number" step=".01" name="subtotal[]" value="{{isset($n) ? old('subtotal.'.$n) : ''}}" class="form-control subtotal" readonly>
  </div>
