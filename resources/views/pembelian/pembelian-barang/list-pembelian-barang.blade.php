                            ...
                            <td>
                                <div class="dropdown dropdown-link">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{ route('pembelian-barang.edit', $value->kode_supplier) }}" class="dropdown-item">{{ __('Edit') }}</a>
                                        <form action="{{ route('pembelian-barang.destroy', $value->kode_supplier) }}" method="post">
                                            @csrf
                                            @method('delete')
