...
@section('container')
    ...
    @endif
    {{-- </div> --}}
    <form class="mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ route('pembelian-barang.index') }}"
        method="get">
        <div class="row">
            <div class="col-2">
            ...
            <div class="col-auto ml-auto">
                <input type="text"
                    class="form-control start datepickerDate {{ $errors->has('start') ? ' is-invalid' : '' }}"
            ...
            <div class="col-auto">
                <input type="text" class="form-control end datepickerDate {{ $errors->has('end') ? ' is-invalid' : '' }}"
                    value="{{ old('end', isset($_GET['end']) ? $_GET['end'] : date('Y-m-d')) }}" name="end"
                    placeholder="Tanggal" autocomplete="off">
                @if ($errors->has('end'))
                    <span class="invalid-feedback" role="alert">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="form-inline">
                                <a href="{{ route('pembelian-barang.edit', $value) }}" class="btn btn-success mr-2">
